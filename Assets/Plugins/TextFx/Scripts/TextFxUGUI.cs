...
#if UNITY_5_2_1p2_FIX || (!UNITY_4 && !UNITY_5_0 && !UNITY_5_1 && !UNITY_5_2_0 && !UNITY_5_2_1)
	...
	public class TextFxUGUI : Text , TextFxAnimationInterface
	{
...
#endif
		{
			...
			if (!m_textFxAnimDrawCall || m_cachedVerts == null)
			{
                ...
                m_animation_manager.UpdateText(text, new UGUITextDataHandler(m_cachedVerts, text.Length), white_space_meshes: true);
