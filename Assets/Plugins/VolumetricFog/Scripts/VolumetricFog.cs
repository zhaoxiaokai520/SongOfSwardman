...
namespace VolumetricFogAndMist {
	...
	public partial class VolumetricFog : MonoBehaviour {
		...
		public static VolumetricFog instance { 
			get { 
				if (_fog==null) {
					if (Camera.main!=null) _fog = Camera.main.GetComponent<VolumetricFog>();
					if (_fog==null) {
		...
		public float density {
			get { return _density; } 
			set { if (value!=_density) { _preset = FOG_PRESET.Custom;_density = value; UpdateMaterialProperties(); UpdateTextureAlpha(); UpdateTexture(); isDirty = true; } }
		}
		...
		public float noiseStrength {
			...
			set { if (value!=_noiseStrength) { _preset = FOG_PRESET.Custom;_noiseStrength = value; UpdateMaterialProperties(); UpdateTextureAlpha(); UpdateTexture(); isDirty = true; } }
		}
		...
		public float distance {
			...
			set { if (value!=_distance) { _preset = FOG_PRESET.Custom; _distance = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float distanceFallOff {
			...
			set { if (value!=_distanceFallOff) { _preset = FOG_PRESET.Custom; _distanceFallOff = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float height {
			get { return _height; } 
			set { if (value!=_height) { _preset = FOG_PRESET.Custom;_height = Mathf.Max(value, 0.00001f); UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float baselineHeight {
			...
			set { if (value!=_baselineHeight) { _preset = FOG_PRESET.Custom;_baselineHeight = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public bool baselineRelativeToCamera {
			...
			set { if (value!=_baselineRelativeToCamera) { _preset = FOG_PRESET.Custom;_baselineRelativeToCamera = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float noiseScale {
			...
			set { if (value!=_noiseScale) { _preset = FOG_PRESET.Custom;_noiseScale = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float alpha {
			get { return _alpha; } 
			set { if (value!=_alpha) { _preset = FOG_PRESET.Custom;_alpha = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public Color color {
			get { return _color; } 
			set { if (value!=_color) { _preset = FOG_PRESET.Custom; _color = value; _skyColor = _color; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public Color specularColor {
			...
			set { if (value!=_specularColor) { _preset = FOG_PRESET.Custom;_specularColor = value; UpdateMaterialProperties(); UpdateTexture(); isDirty = true; } }
		}
		...
		public float specularThreshold {
			...
			set { if (value!=_specularThreshold) { _preset = FOG_PRESET.Custom;_specularThreshold = value; UpdateTexture(); isDirty = true; } }
		}
		...
		public float specularIntensity {
			...
			set { if (value!=_specularIntensity) { _preset = FOG_PRESET.Custom;_specularIntensity = value; UpdateMaterialProperties(); UpdateTexture(); isDirty = true; } }
		}
		...
		public Vector3 lightDirection {
			...
			set { if (value!=_lightDirection) { _preset = FOG_PRESET.Custom;_lightDirection = value; UpdateMaterialProperties(); UpdateTexture (); isDirty = true; } }
		}
		...
		public float lightIntensity {
			...
			set { if (value!=_lightIntensity) { _preset = FOG_PRESET.Custom;_lightIntensity = value; UpdateMaterialProperties(); UpdateTexture(); isDirty = true; } }
		}
		...
		public Color lightColor {
			...
			set { if (value!=_lightColor) { _preset = FOG_PRESET.Custom;_lightColor = value; UpdateMaterialProperties(); UpdateTexture(); isDirty = true; } }
		}
		...
		public float speed {
			get { return _speed; } 
			set { if (value!=_speed) { _preset = FOG_PRESET.Custom;_speed = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public Vector3 windDirection {
			...
			set { if (value!=_windDirection) { _preset = FOG_PRESET.Custom;_windDirection = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		[SerializeField]
		Color _skyColor = new Color (0.89f, 0.89f, 0.89f, 1);
		public Color skyColor {
			get { return _skyColor; } 
			set { if (value!=_skyColor) { _preset = FOG_PRESET.Custom; _skyColor = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float skyHaze {
			get { return _skyHaze; } 
			set { if (value!=_skyHaze) { _preset = FOG_PRESET.Custom;_skyHaze = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float skySpeed {
			...
			set { if (value!=_skySpeed) { _preset = FOG_PRESET.Custom;_skySpeed = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float skyNoiseStrength {
			...
			set { if (value!=_skyNoiseStrength) { _preset = FOG_PRESET.Custom; _skyNoiseStrength = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float skyAlpha {
			...
			set { if (value!=_skyAlpha) { _preset = FOG_PRESET.Custom; _skyAlpha = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		
		[SerializeField]
		float _skyDepth = 0.999f;
		public float skyDepth {
			get { return _skyDepth; } 
			set { if (value!=_skyDepth) { _skyDepth = value; UpdateMaterialProperties(); isDirty = true; } }
		}

		#endregion

		#region Void Area settings
		...
		[SerializeField]
		bool _fogVoidInverted = false;
		public bool fogVoidInverted {
			get { return _fogVoidInverted; } 
			set { if (value!=_fogVoidInverted) { _fogVoidInverted = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		[SerializeField]
		GameObject[] _pointLights = new GameObject[MAX_POINT_LIGHTS];

		[SerializeField]
		float[] _pointLightRanges = new float[MAX_POINT_LIGHTS];

		[SerializeField]
		float[] _pointLightIntensities = new float[MAX_POINT_LIGHTS] { 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f };
		
		[SerializeField]
		float[] _pointLightIntensitiesMultiplier = new float[MAX_POINT_LIGHTS] { 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f };

		[SerializeField]
		Vector3[] _pointLightPositions = new Vector3[MAX_POINT_LIGHTS];

		[SerializeField]
		Color[] _pointLightColors = new Color[MAX_POINT_LIGHTS] { new Color(1,1,0,1), new Color(1,1,0,1), new Color(1,1,0,1), new Color(1,1,0,1), new Color(1,1,0,1), new Color(1,1,0,1) };

		[SerializeField]
		bool _pointLightTrackingAuto = false;
		public bool pointLightTrackAuto {
			get { return _pointLightTrackingAuto; }
			set { if (value != _pointLightTrackingAuto) { _pointLightTrackingAuto = value; TrackPointLights(); isDirty = true; } }
		}

		[SerializeField]
		int _pointLightTrackingCount = 0;
		public int pointLightTrackingCount {
			get { return _pointLightTrackingCount; }
			set { if (value != _pointLightTrackingCount) { _pointLightTrackingCount = Mathf.Clamp (value, 0, MAX_POINT_LIGHTS); TrackPointLights(); isDirty = true; } }
		}
		...
		public int downsampling {
			...
			set { if (value!=_downsampling) { _preset = FOG_PRESET.Custom; _downsampling = value; isDirty = true; } }
		}

		[SerializeField]
		bool _edgeImprove = false;
		public bool edgeImprove {
			get { return _edgeImprove; } 
			set { if (value!=_edgeImprove) { _preset = FOG_PRESET.Custom; _edgeImprove = value; UpdateMaterialProperties(); isDirty = true; } }
		}


		[SerializeField]
		float _edgeThreshold = 0.0005f;
		public float edgeThreshold {
			get { return _edgeThreshold; } 
			set { if (value!=_edgeThreshold) { _preset = FOG_PRESET.Custom; _edgeThreshold = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float stepping {
			...
			set { if (value!=_stepping) { _preset = FOG_PRESET.Custom;_stepping = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public float steppingNear {
			...
			set { if (value!=_steppingNear) { _preset = FOG_PRESET.Custom;_steppingNear = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		public bool dithering {
			...
			set { if (value!=_dithering) { _dithering = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		[SerializeField]
		bool _lightScatteringEnabled = false;
		public bool lightScatteringEnabled {
			get { return _lightScatteringEnabled; } 
			set { if (value!=_lightScatteringEnabled) { _lightScatteringEnabled = value; UpdateMaterialProperties(); isDirty = true; } }
		}

		[SerializeField]
		float _lightScatteringSpread = 0.686f;
		public float lightScatteringSpread {
			get { return _lightScatteringSpread; } 
			set { if (value!=_lightScatteringSpread) {_lightScatteringSpread = value; UpdateMaterialProperties(); isDirty = true; } }
		}

		[SerializeField]
		int _lightScatteringSamples = 24;
		public int lightScatteringSamples {
			get { return _lightScatteringSamples; } 
			set { if (value!=_lightScatteringSamples) { _lightScatteringSamples = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		
		[SerializeField]
		float _lightScatteringWeight = 2.3f;
		public float lightScatteringWeight {
			get { return _lightScatteringWeight; } 
			set { if (value!=_lightScatteringWeight) {_lightScatteringWeight = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		
		[SerializeField]
		float _lightScatteringIllumination = 18f;
		public float lightScatteringIllumination {
			get { return _lightScatteringIllumination; } 
			set { if (value!=_lightScatteringIllumination) {_lightScatteringIllumination = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		
		[SerializeField]
		float _lightScatteringDecay = 0.986f;
		public float lightScatteringDecay {
			get { return _lightScatteringDecay; } 
			set { if (value!=_lightScatteringDecay) {_lightScatteringDecay = value; UpdateMaterialProperties(); isDirty = true; } }
		}

		[SerializeField]
		float _lightScatteringExposure= 0.02f;
		public float lightScatteringExposure {
			get { return _lightScatteringExposure; } 
			set { if (value!=_lightScatteringExposure) { _lightScatteringExposure = value; UpdateMaterialProperties(); isDirty = true; } }
		}
		...
		void OnEnable () {
			...
			UpdateTextureAlpha();
			UpdateSun ();
			if (_pointLightTrackingAuto) TrackPointLights(); else UpdatePointLights();
			FogOfWarInit();
			if (fogOfWarTexture==null) FogOfWarUpdateTexture();
			UpdatePreset();
		...
		void Update () {
			...
			// Restores fog of war
			if (_fogOfWarEnabled) FogOfWarUpdate();
		}
		...
		void UpdateRenderComponents() {
			if (_renderOpaque) {
				...
				if (v==null) {
					v = gameObject.AddComponent<VolumetricFogPreT>();
				}
				v.fog = this;
			} else {
				VolumetricFogPreT v = GetComponent<VolumetricFogPreT>();
				...
				VolumetricFogPosT post = GetComponent<VolumetricFogPosT>();
				if (post==null) {
					post = gameObject.AddComponent<VolumetricFogPosT>();
				}
				post.fog = this;
			}
		}
		...
		internal void DoOnRenderImage (RenderTexture source, RenderTexture destination) {
			...
			for (int k=0;k<MAX_POINT_LIGHTS;k++) {
				...
				if (_pointLightRanges[k] * _pointLightIntensities[k] > 0) {
					...
					fogMat.SetVector("_FogPointLightPosition" + ks, _pointLightPositions[k]);
					fogMat.SetColor ("_FogPointLightColor"    + ks, _pointLightColors[k] * _pointLightIntensities[k] * _pointLightIntensitiesMultiplier[k]);
					fogMat.SetFloat ("_FogPointLightRadius"   + ks, 1.0f / (_pointLightRanges[k] * _pointLightRanges[k] + 0.0001f));
				}
			}
		...
		public void CheckWaterLevel(bool baseZero) {
			...
			if (_baselineHeight>mainCamera.transform.position.y || baseZero) _baselineHeight = 0;
		...
		void UpdateMaterialHeights() {
			...
			if (_fogVoidInverted && _fogVoidRadius>0 && _character!=null) {
				baseHeight = _character.transform.position.y + baseHeight;
				_fogVoidPosition.y = baseHeight;
			}
			...
			if (_fogVoidInverted && _character==null) {
				fogMat.SetVector("_FogVoidPosition", _fogVoidPosition);
			} else {
		...
		void UpdateMaterialProperties() {
			...
			Vector4 fogStepping = new Vector4(1.0f/ (_stepping + 1.0f), 1/(1+_steppingNear), _edgeThreshold, _dithering ? 1f: 0f);
			if (!_edgeImprove) fogStepping.z = 0;
			fogMat.SetVector ("_FogStepping", fogStepping );
			fogMat.SetFloat ("_FogAlpha", currentFogAlpha);
			UpdateMaterialHeights();
			float scale = 0.01f / _noiseScale;
			fogMat.SetFloat  ("_FogScale", scale);
			fogMat.SetVector ("_FogWindDir", _windDirection.normalized * _speed / scale);
			fogMat.SetFloat  ("_FogDensity", 1.0f / _density);
			fogMat.SetVector ("_FogDistance", new Vector4(_distance, (_distance * _distanceFallOff) + 0.000001f, _maxFogLength, _distance * (1.0f - _distanceFallOff)));
			...
			if (_fogVoidRadius>0 && _fogVoidFallOff>0) {
				...
				if (_fogVoidInverted) {
					if (_fogVoidHeight>0 && _fogVoidDepth>0) {
						shaderKeywords.Add ("FOG_BOX_VOID_INVERTED");
					} else {
						shaderKeywords.Add ("FOG_VOID_INVERTED");
						voidData.y = _fogVoidRadius * _fogVoidRadius;
						voidData.x /= scale;
						voidData.z /= scale;
					}
				} else if (_fogVoidHeight>0 && _fogVoidDepth>0) {
		...
		void UpdateScatteringData() {
			if (_sun==null) return;
			Vector2 screenSunPos = mainCamera.WorldToViewportPoint(_sun.transform.position);
			if (screenSunPos!=oldSunPos) {
				oldSunPos = screenSunPos;
				fogMat.SetVector ("_SunPosition", screenSunPos);
				sunFade =  Mathf.SmoothStep(1,0, (screenSunPos - Vector2.one * 0.5f).magnitude * 0.5f);
			}
			...
			fogMat.SetVector ("_FogScatteringData2", new Vector3(_lightScatteringIllumination, _lightScatteringDecay, 0));
		}
		...
		void UpdateTexture () {
			...
			for (int k=0; k<adjustedColors.Length; k++) {
				...
				float r = Mathf.Clamp01 ((a - adjustedColors [indexg].a) * nyspec);
		...
		public GameObject GetPointLight(int index) {
			if (index<0 || index>_pointLights.Length) return null;
			return _pointLights[index];
		}

		public void SetPointLight(int index, GameObject pointLight) {
			if (index<0 || index>_pointLights.Length) return;
		...
		public float GetPointLightRange(int index) {
			if (index<0 || index>_pointLightRanges.Length) return 0;
			return _pointLightRanges[index];
		}

		public void SetPointLightRange(int index, float range) {
			if (index<0 || index>_pointLightRanges.Length) return;
		...
		public float GetPointLightIntensity(int index) {
			if (index<0 || index>_pointLightIntensities.Length) return 0;
			return _pointLightIntensities[index];
		}

		public void SetPointLightIntensity(int index, float intensity) {
			if (index<0 || index>_pointLightIntensities.Length) return;
		...
		public float GetPointLightIntensityMultiplier(int index) {
			if (index<0 || index>_pointLightIntensitiesMultiplier.Length) return 0;
		...
		public void SetPointLightIntensityMultiplier(int index, float intensityMultiplier) {
			if (index<0 || index>_pointLightIntensitiesMultiplier.Length) return;
		...
		public Vector3 GetPointLightPosition(int index) {
			if (index<0 || index>_pointLightPositions.Length) return Vector3.zero;
			return _pointLightPositions[index];
		}
		
		public void SetPointLightPosition(int index, Vector3 position) {
			if (index<0 || index>_pointLightPositions.Length) return;
		...
		public Color GetPointLightColor(int index) {
			if (index<0 || index>_pointLightColors.Length) return Color.white;
			return _pointLightColors[index];
		}
		
		public void SetPointLightColor(int index, Color color) {
			if (index<0 || index>_pointLightColors.Length) return;
		...
		void TrackPointLights() {
			if (!_pointLightTrackingAuto) return;

			Light[] lights = GameObject.FindObjectsOfType<Light>();

			for (int k=0;k<MAX_POINT_LIGHTS;k++) {
				GameObject g = null;
				if (k<_pointLightTrackingCount) g = GetNearestLight(lights);
				_pointLights[k] = g;
		...
		GameObject GetNearestLight(Light[] lights) {
			...
			for (int k=0;k<lights.Length;k++) {
				if (lights[k]==null || !lights[k].enabled || lights[k].type != LightType.Point) continue;
			...
			if (selected>=0) lights[selected] = null;
			return nearest;
		}
