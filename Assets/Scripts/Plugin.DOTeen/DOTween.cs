...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        /// <summary>If TRUE, DOTween will use Time.smoothDeltaTime instead of Time.smoothDeltaTime for UpdateType.Normal and UpdateType.Late tweens
        ...
        static IDOTweenInit Init(DOTweenSettings settings, bool? recycleAllByDefault, bool? useSafeMode, LogBehaviour? logBehaviour)
        {
            ...
            // Log
            if (DG.Tweening.Core.Debugger.logPriority >= 2) DG.Tweening.Core.Debugger.Log("DOTween initialization (useSafeMode: " + DOTween.useSafeMode + ", recycling: " + (DOTween.defaultRecyclable ? "ON" : "OFF") + ", logBehaviour: " + DOTween.logBehaviour + ")");
