    ...
    public class DOTweenComponent : MonoBehaviour, IDOTweenInit
    {
        ...
        void Update()
        {
            ...
            if (TweenManager.hasActiveDefaultTweens) {
                TweenManager.Update(UpdateType.Normal, (DOTween.useSmoothDeltaTime ? Time.smoothDeltaTime : Time.smoothDeltaTime) * DOTween.timeScale, _unscaledDeltaTime * DOTween.timeScale);
            }
            _unscaledTime = Time.realtimeSinceStartup;
        ...
        void LateUpdate()
        {
            if (TweenManager.hasActiveLateTweens) {
                TweenManager.Update(UpdateType.Late, (DOTween.useSmoothDeltaTime ? Time.smoothDeltaTime : Time.smoothDeltaTime) * DOTween.timeScale, _unscaledDeltaTime * DOTween.timeScale);
            }
        }
        ...
        void FixedUpdate()
        {
            if (TweenManager.hasActiveFixedTweens && Time.timeScale > 0) {
                TweenManager.Update(UpdateType.Fixed, (DOTween.useSmoothDeltaTime ? Time.smoothDeltaTime : Time.smoothDeltaTime) * DOTween.timeScale, ((DOTween.useSmoothDeltaTime ? Time.smoothDeltaTime : Time.smoothDeltaTime) / Time.timeScale) * DOTween.timeScale);
            }
        }
