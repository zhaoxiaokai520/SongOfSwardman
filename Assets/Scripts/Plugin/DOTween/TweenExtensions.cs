...
//                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNestedTween(t); return;
//            }
//
...
//        }
        ...
        public static T Pause<T>(this T t) where T : Tween
        {
            if (t == null) {
                ...
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNestedTween(t); return t;
            }
        ...
        public static Vector3 PathGetPoint(this Tween t, float pathPercentage)
        {
            ...
            if (t == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNullTween(t); return Vector3.zero;
            } else if (!t.active) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogInvalidTween(t); return Vector3.zero;
            } else if (t.isSequenced) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNestedTween(t); return Vector3.zero;
            }

            TweenerCore<Vector3, Path, PathOptions> pathTween = t as TweenerCore<Vector3, Path, PathOptions>;
            if (pathTween == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNonPathTween(t); return Vector3.zero;
            } else if (!pathTween.endValue.isFinalized) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogWarning("The path is not finalized yet"); return Vector3.zero;
            }
        ...
        {
            if (t == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNullTween(t); return null;
            } else if (!t.active) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogInvalidTween(t); return null;
            } else if (t.isSequenced) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNestedTween(t); return null;
            }

            TweenerCore<Vector3, Path, PathOptions> pathTween = t as TweenerCore<Vector3, Path, PathOptions>;
            if (pathTween == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNonPathTween(t); return null;
            } else if (!pathTween.endValue.isFinalized) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogWarning("The path is not finalized yet"); return null;
            }
        ...
        public static float PathLength(this Tween t)
        {
            if (t == null) {
                ...
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNestedTween(t); return -1;
            }
