...
public struct VecInt3
{
    ...
    public float fx { get { return (float)x * PrecisionFactor; } set { x = Mathf.RoundToInt(value * FloatPrecision); } }

    public float fy { get { return (float)y * PrecisionFactor; } set { y = Mathf.RoundToInt(value * FloatPrecision); } }

    public float fz { get { return (float)z * PrecisionFactor; } set { z = Mathf.RoundToInt(value * FloatPrecision); } }
...
#endif
            Debug.LogWarning("Caught exception while Num = " + this);
        }
	...
	{
		return new VecInt3(Mathf.RoundToInt((float)a.x * (1f - f)) + Mathf.RoundToInt((float)b.x * f), Mathf.RoundToInt((float)a.y * (1f - f)) + Mathf.RoundToInt((float)b.y * f), Mathf.RoundToInt((float)a.z * (1f - f)) + Mathf.RoundToInt((float)b.z * f));
	}
	...
	{
        lhs.x = Mathf.RoundToInt((float)lhs.x * rhs);
        lhs.y = Mathf.RoundToInt((float)lhs.y * rhs);
        lhs.z = Mathf.RoundToInt((float)lhs.z * rhs);
		return lhs;
	}
    ...
    public static VecInt3 Min(VecInt3 lhs, VecInt3 rhs) { return new VecInt3(Mathf.Min(lhs.x, rhs.x), Mathf.Min(lhs.y, rhs.y), Mathf.Min(lhs.z, rhs.z)); }
    public static VecInt3 Max(VecInt3 lhs, VecInt3 rhs) { return new VecInt3(Mathf.Max(lhs.x, rhs.x), Mathf.Max(lhs.y, rhs.y), Mathf.Max(lhs.z, rhs.z)); }
